...
// TransferTx performs a mone transfer from one account to the other.
...
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		// to avoid dead locks, order of query execution should be one. from account first and then to account.
...
func addMoney(
	...
	return // equivalent to return account1, account2, err
}
